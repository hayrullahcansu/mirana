...
func NewClient(userId string) *AmericanSPClient {

	client := &AmericanSPClient{
...
func (c *AmericanSPClient) PlaceBet(internalId string, amount float32) bool {
...
func (c *AmericanSPClient) placeBet(internalId string, amount float32, isInsurance bool) bool {
...
func (c *AmericanSPClient) AddMoney(amount float32) {
